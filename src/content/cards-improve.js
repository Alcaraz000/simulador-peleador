...
export const CARTAS_MEJORA = [
  ...
  { id: 'cuello', titulo: 'Trabajo de cuello', texto: 'Feo, incómodo y te salva de un nocaut.', mods: { menton: 4 }, etapas: SIEMPRE, disciplinas: TODAS, rareza: 'normal' },
  { id: 'dieta', titulo: 'Dieta en serio por primera vez', texto: 'Nada de asado hasta después de la pelea.', mods: { disciplinaPersonal: 5, forma: 5 }, etapas: SIEMPRE, disciplinas: TODAS, rareza: 'rara' },
