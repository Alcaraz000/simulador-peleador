...
export const OPINIONES_ENTRENADOR = {
  ...
  confiado: [
    ...
    'Salís favorito, y con razón. Hacé tu pelea y esto se resuelve solo.',
    ...
    'Es una buena oferta contra un rival que podés manejar. Yo la tomaría.',
  ],
  parejo: [
    'Esto va a estar mano a mano con {rival}. Ni fácil ni imposible.',
    'Pelea pareja. El que la piense mejor esa noche se la lleva.',
    '{rival} te complica, pero no te gana solo. Va a ser cuestión de detalles.',
    'No hay favorito claro acá. Preparate en serio, esta se juega punto a punto.',
  ...
  cauteloso: [
    ...
    'No es imposible, pero vas de abajo. Hay que pelear inteligente, no valiente.',
  ...
  desafio: [
    ...
    'Es un desafío grande. Puede salir una hazaña o puede salir feo.',
  ...
  no_recomendado: [
    ...
    'Con cómo estás llegando, esto es un riesgo que no hace falta correr.',
...
export const OPINIONES_ENTRENADOR_TITULO = {
  ...
  confiado: [
    'Es por el {enJuego}, y lo tenés a favor. No aflojes hasta el campanazo final.',
    'Vas por el {enJuego} con ventaja. Concentración y esto queda en casa.',
  ],
  parejo: [
    'Se juega el {enJuego} y va a estar durísima. No hay margen para relajarse ni un round.',
